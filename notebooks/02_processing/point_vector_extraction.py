#This file takes in raw image data and outputs the centers and radii of circles found within as a .dat file 
...
def background_finder():
    root_folder = '/home/bay22/github_repos/RIMSAR/data/01_raw/Acquisition_001/'
...
for image_number in range(0,5000,1):
    ...
    #saving point_data
    np.savetxt('/home/bay22/github_repos/RIMSAR/data/03_processed/point_data/point_data_'+str(image_number)+'.dat',point_data)
